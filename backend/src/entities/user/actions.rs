...
pub async fn upsert_from_github_user(pool: &PgPool, github_user: GitHubUser) -> Result<User> {
    let user = UserForUpsert::new(
        github_user
            .login
            .clone()
