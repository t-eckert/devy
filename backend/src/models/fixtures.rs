use super::{Feed, Post, Profile, User};

pub fn profile_0001() -> Profile {
    Profile {
        id: "d9b1d4b3-0301-46eb-ae7a-982370314a02".to_string(),
