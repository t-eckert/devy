...
VALUES 
	...
	('d97bdc36-cc04-4e94-91ab-ebd3bba2e0a1', 'johndoe', 'john.doe@email.com', 'johndoe'),
	('6f2db7f3-3c72-4a88-bc63-09ce924e48c4', 'janedoe', 'jane.doe@email.com', 'janedoe'),
	('af6bdc89-93ab-4c15-bf07-8d4a2a8452ce', 'codingmaster', 'coding.master@email.com', 'codingmaster'),
	('d33f21a1-52b7-4eac-9a2e-fa65fd883e9d', 'sqlwizard', 'sql.wizard@email.com', 'sqlwizard'),
	('b1e9c89d-6c5e-4c6a-a732-870c1e1e142b', 'pythonista', 'pythonista@email.com', 'pythonista'),
	('4a6e8b77-5900-4a55-82eb-026d16f3a93e', 'javascripter', 'javascripter@email.com', 'javascripter'),
	('84c07e46-1daa-4a9f-9e38-9a67c7b9836d', 'webdev', 'web.dev@email.com', 'webdev'),
	('c0f6f30a-60df-4f2e-a1db-9ff6f3a3ea39', 'dbadmin', 'db.admin@email.com', 'dbadmin'),
	('2f3d6a17-86a2-42e2-88aa-9e16d2ff42d7', 'datascientist', 'data.scientist@email.com', 'datascientist'),
	('678b5e8f-4ee6-429f-aade-426e8a86f6c4', 'devops', 'dev.ops@email.com', 'devops'),
	('1b3d6f47-7d3a-4f89-81d7-496d3fa6e98b', 'frontendguru', 'frontend.guru@email.com', 'frontendguru'),
	('a6e8c7f2-93f5-47ad-bce3-7b9ffaa5b0dd', 'backendninja', 'backend.ninja@email.com', 'backendninja'),
	('b2d8e9c4-5f5c-41e3-bb27-8f7dc9f9e7cb', 'fullstackdev', 'fullstack.dev@email.com', 'fullstackdev'),
	('0a5c4e3f-3f90-44a7-94c8-0f01db408a74', 'codelearner', 'code.learner@email.com', 'codelearner'),
